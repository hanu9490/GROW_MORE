  ...
  return (
    <div className="service-card-Data-science">
      ...
      <div className="service-card-Data-science-detail">
        ...
        <p>
          A cloud data warehouse is a centralized repository that stores,
          integrates, and manages large volumes of data from various sources in
          a cloud environment. Unlike traditional on-premises data warehouses,
          ...
          businesses to store and process data without the need to invest in and
